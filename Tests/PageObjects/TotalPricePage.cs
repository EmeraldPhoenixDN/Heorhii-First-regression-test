...
namespace Tests.PageObjects
{
    public class TotalPricePage : BasePage
    {
        ...
        public IWebElement ItemPrice => _driver.FindElement(By.XPath("//div[@class='summary_subtotal_label']"));
        ...
        public CompletePage FinishBtn(WebDriverWaits wait)
        {
            wait.FluentWait(_driver, () => Finish_Btn, 10);
            Finish_Btn.Click();
            return new CompletePage(_driver);
        }
    }
}